...
class bisect extends Component {
    ...
    render() {
        ...
        return (
            <div className="false">
            <div className="bgfalse">
                <div className="nameconF"><img src={a2} width="500" height="160" /></div>
                <div className="example-inputfucF"><Input size="large"  placeholder={this.state.function} onChange={this.onChangefunction} /></div>
                <div className="example-inputxlF"><Input size="large" placeholder={this.state.Xl} onChange={this.onChangeVariableXl} /></div>
                <div className="example-inputxrF"><Input size="large" placeholder={this.state.Xr} onChange={this.onChangeVariableXr} /></div>
                <div className="resetF">Reset</div>
                <div className="submitF" onClick={this.onSubmit}>Submit</div>
                <div className="apifalse"  onClick={this.onExample}>Example</div>
                <div className="homefalse" ><a href="/">Home</a></div>
