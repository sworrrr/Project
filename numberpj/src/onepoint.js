...
class bisect extends Component {
    ...
    onSubmit() {
            ...
            inputy['error'][n] = 1
            xold = this.funcChange(xs)
            inputy['xnew'][n] = xold
            /* loop ทำ Iteration*/
            do {
                inputy['xold'][n + 1] = xold
                fx[n+1]=this.funcChange(xold)
                xnew=this.funcChange(xold)
    ...
    render() {
        ...
        return (
            <div className="onep">
            <div className="bgonep">
                <div className="namecononep"><img src={a3} width="500" height="160" /></div>
                <div className="example-inputfuconep"><Input size="large"  placeholder={this.state.function} onChange={this.onChangefunction} /></div>
                <div className="example-inputxonep"><Input size="large" placeholder={this.state.Xstart} onChange={this.onChangeVariableXstart} /></div>
                <div className="resetonep"><a href="/onepoint">Reset</a></div>
                <div className="submitonep" onClick={this.onSubmit}>Submit</div>
                <div className="apionepoint"  onClick={this.onExample}>Example</div>
                <div className="homeonepoint" ><a href="/">Home</a></div>
